...
To achieve this goal of beauty, we will pay attention to the aesthetic aspects
of our visualization as well as maintaining correctness.  In particular, we
should ensure that transitions are smooth and not jarring, and that our
...
vertices $(u,v)$, and we will assume, again without loss of generality, that the depth of $u$ is one
